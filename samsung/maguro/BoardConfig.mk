...
#TARGET_KERNEL_SOURCE := kernel/samsung/maguro
...
BOARD_EGL_CFG := device/samsung/maguro/egl.cfg
BOARD_CREATE_maguro_HDCP_KEYS_SYMLINK := true
...
TARGET_RECOVERY_UI_LIB := librecovery_ui_maguro

# device-specific extensions to the updater binary
TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_maguro
TARGET_RELEASETOOLS_EXTENSIONS := device/samsung/maguro
...
BOARD_LIB_DUMPSTATE := libdumpstate.maguro

BOARD_USES_SECURE_SERVICES := true

BOARD_HAS_NO_SELECT_BUTTON := true
#BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/samsung/maguro/recovery_keys.c
#BOARD_CUSTOM_RECOVERY_KEYMAPPING := device/samsung/maguro/recovery_keys.c
